# This is version 3.
# Here I basically use the same script as WhoBPyT_HCP_subs_version_2.py but this is for task fMRI.

# Here I combine all the tasks using a second user input which is one of : 'WM', 'MOTOR', 'SOCIAL', or 'LANGUAGE' for the different tasks

# ------------------------------------

# IMPORTANT!

# TR = 720 ms or 0.72 (not 2 sec!)
...
# note that I_external has been set to 0.02 in the above params as this is task sims. 
# This param is 0 for rest sims. 
...
# output_path = '/external/rprshnas01/netdata_kcni/jglab/MemberSpaces/Data/Shrey/WhoBPyT/200_subjects_WhoBPyT_task_run_pkls'
...
# output_path = '/external/rprshnas01/netdata_kcni/jglab/MemberSpaces/Data/Shrey/WhoBPyT/200_subjects_WhoBPyT_task_run_pkls_fake_time'

output_path = '/external/rprshnas01/netdata_kcni/jglab/MemberSpaces/Data/Shrey/WhoBPyT/sample_10_subjects_WhoBPyT_task_run_pkls_real_time_w_Iext'

# filename = output_path + '/Subj_{0}_fittingresults_motor_task_stim_exp.pkl'.format(sub_id)
# filename = output_path + '/Subj_{0}_fittingresults_social_task_stim_exp.pkl'.format(sub_id)
# filename = output_path + '/Subj_{0}_fittingresults_wm_task_stim_exp.pkl'.format(sub_id)
# filename = output_path + '/Subj_{0}_fittingresults_language_task_stim_exp.pkl'.format(sub_id)
